PING_PROTO_FILES = $(shell find ./pingkratos/clientpingkratos -name "*.proto")
...
.PHONY: generate
generate:
	protoc --proto_path=./pingkratos/clientpingkratos \
		   --proto_path=./internal/proto3ps \
		   --go_out=paths=source_relative:./pingkratos/clientpingkratos \
		   --go-http_out=paths=source_relative:./pingkratos/clientpingkratos \
		   --go-grpc_out=paths=source_relative:./pingkratos/clientpingkratos \
...
.PHONY: clean
clean:
	rm -f ./pingkratos/clientpingkratos/*.pb.go
	rm -f ./openapi.yaml
